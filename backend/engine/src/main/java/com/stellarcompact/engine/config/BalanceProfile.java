...
public record BalanceProfile(
    ...
    /**
     * Compact constructor. Home placement is additive in E2-04; a profile (or a
     * test fixture) that omits it gets inert {@link HomePlacement#defaults()} so it
     * stays loadable and deterministic (forward-compatible, like the tech DAG /
     ...
     * pre-E2-04 fixtures that build a profile positionally keep compiling unchanged.
     */
    public BalanceProfile(
            String name,
            int version,
        ...
        this(name, version, resources, population, market, construction, combat,
                tech, diplomacy, victory, tick, HomePlacement.defaults());
    }
